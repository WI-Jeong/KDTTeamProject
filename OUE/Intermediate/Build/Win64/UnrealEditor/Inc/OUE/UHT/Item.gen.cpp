...
#include "Junglae/Item/Item.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeItem() {}
// Cross Module References
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
	OUE_API UClass* Z_Construct_UClass_UItem();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UItem_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Junglae/Item/Item.h" },
		{ "ModuleRelativePath", "Junglae/Item/Item.h" },
	};
#endif
	...
	template<> OUE_API UClass* StaticClass<UItem>()
	{
		return UItem::StaticClass();
	}
	...
	UItem::~UItem() {}
	struct Z_CompiledInDeferFile_FID_OUE_Source_OUE_Junglae_Item_Item_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OUE_Source_OUE_Junglae_Item_Item_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UItem, UItem::StaticClass, TEXT("UItem"), &Z_Registration_Info_UClass_UItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UItem), 2477541415U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OUE_Source_OUE_Junglae_Item_Item_h_1034574747(TEXT("/Script/OUE"),
		Z_CompiledInDeferFile_FID_OUE_Source_OUE_Junglae_Item_Item_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OUE_Source_OUE_Junglae_Item_Item_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
